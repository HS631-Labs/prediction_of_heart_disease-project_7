...
pseudo_3.2 <- logisticPseudoR2s(model3.2) #model without outliers and significant predictors with high VIF 

```

# Confusion matrix for  models 2.2_reduced and 3.2 using heart dataset with no outliers 
```{r}
...
table(heartdf_no_outlier$eval_1)
...
table(heartdf_no_outlier$eval_2)
```
