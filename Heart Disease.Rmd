...
For every unit change in interaction between Presence of Exercise Induced Angina and Nature of the ST Slope on ECG the odds of presence of heart disease are multiplied by a factor of 2.7 while holding the other variables constant .
