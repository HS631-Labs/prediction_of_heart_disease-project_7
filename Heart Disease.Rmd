...
log_dataframe <- data.frame(sq_age, log_cholesterol,log_RBP, sqrt_MaxHR, heart_dfnum$ST_Slope, heart_dfnum$Sex, heart_dfnum$ChestPainType, heart_dfnum$FastingBS,heart_dfnum$RestingECG, heart_dfnum$ExerciseAngina)
str(log_dataframe)
