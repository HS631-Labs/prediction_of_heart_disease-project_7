...
#Subset heart_dataframe - extract all numeric variables 
```{r}
heart_numeric <- select_if(heart_dataframe, is.numeric)
heart_numeric
```
#Chunk 6: Characterizing distributions of variables - NUMERIC VARIABLES  
```{r}
...
#Chunk 7: Characterizing distributions of variables - FACTOR VARIABLES  
