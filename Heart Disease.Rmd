...
shapiro.test(heart_dataframe$Age) 
...
colnames(heart_dfnum) <- c("Age", "Cholesterol", "Resting Blood Pressure", "Old Peak", "Max Heart Rate" , "ST Slope", "Gender","Types of Chest Pain", "Fasting Blood Sugar Levels", "Resting ECG", "Exercise Induced Angina" )
